...
public class Final extends World
{
    ...
    private static final int HARD = 1500;
    ...
    public void nextLevel()
    {
        if(distance > 7000)
        {
            ...
            winner = true;
            addObject(new ScoreBoard("SUCCESS", "YOU WIN!!!", "Click For Menu" ,0), 418,185);
        }
    }
    ...
    {
        List checkSHIP = getObjects(ufo.class);
        if(checkSHIP.size() < 2)
        {
            if(distance > addUFO)
            {
                addObject(new ufo(),790, Greenfoot.getRandomNumber(380) + 10);
                addUFO +=300;
            }
        }
    }
